...
class PlantDetails extends Component {
    ...
    componentDidMount() {
        ...
        plantService.getPlantDetailsFromSparqlQuery(plantId, {
            plantName: this.props.location.state.plantName,
            plantSpecies: this.props.location.state.plantSpeciesName
        }).then((plantDetails) => {
            console.log("plantD: ", plantDetails)
            this.setState({
                ...this.state,
            ...
            <div className="plant-details">
                ...
                <div style={{display: "flex"}}>
                    ...
                    <div className="title-box-plant-details"
                         style={{
                             backgroundImage: `url(${this.state.plantDetails.plantImageURL})`,
                             backgroundSize: "85%"
                         }}
                    >
                    </div>
                ...
                <Grid container style={{display: "grid"}}>
                    <div style={{
                        ...
                        <div className="details-bottom" onClick={() => this.setState({
                            ...this.state,
                    ...
                    <div style={{
                        ...
                        <div className="details-bottom" onClick={() => this.setState({
                            ...this.state,
                            showMoreMaintenance: !this.state.showMoreMaintenance
                        })}>
                            <div className="icon-plant-details">
                    ...
                    <div style={{
                        ...
                        <div className="details-bottom" onClick={() => this.setState({
                            ...this.state,
                            showMoreDiseases: !this.state.showMoreDiseases
                        })}>
                            <div className="icon-plant-details">
                    ...
                    <div style={{
                        ...
                        {this.state.showMoreLocation === true ?
                            <p className="plus-plant-details">Latitude: <span
                                style={{fontWeight: "bold"}}>{this.state.plantDetails.latitudeMarker}</span> -
                                Longitude: <span
                                    style={{fontWeight: "bold"}}>{this.state.plantDetails.longitudeMarker}</span></p>
                            : ""}
                    </div>
                    <div style={{
                        borderBottom: "2px solid #888",
                        ...
                        <div className="details-bottom" onClick={() => this.setState({
                            ...this.state,
                            showMoreSeason: !this.state.showMoreSeason
                        })}>
                            <div className="icon-plant-details">
                                {this.state.showMoreSeason === false ? <AddIcon/> : <RemoveIcon/>}
                            </div>
                            <p id="location-plant-title">Season occurence</p>
                        </div>
                        {this.state.showMoreSeason === true ?
                            <p className="plus-plant-details" style={{fontWeight: "bold", fontStyle: "oblique", fontSize: "larger"}}>{this.state.plantDetails.seasons}</p>
                            : ""}
                    </div>
                </Grid>
                            ...
                            >
                                ...
                                <div className="flex flex-space-between flex-middle" style={{marginLeft: "34%"}}>
                                    ...
                                    <Button variant="contained" color="primary"
                                            style={{backgroundColor: "#4A614A", color: "#E0E4DA"}}
                                            onClick={() => {
                                                this.setState({...this.state, displayAddCommentModal: false})
                                            }}>
                                        Cancel
                                    </Button>
                                </div>
